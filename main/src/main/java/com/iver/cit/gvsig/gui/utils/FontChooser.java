...
public class FontChooser extends JPanel implements IWindow {
	...
	String[] styleList = new String[] { PluginServices.getText(this, "Plain"),
			PluginServices.getText(this, "Bold"),
			PluginServices.getText(this, "Italic") };
	String[] sizeList = new String[] { "2", "4", "6", "8", "10", "12", "14",
	...
	private FontChooser() {
		// super(parent, modal);
		jbInit();
		setListValues(jFontList, GraphicsEnvironment
	...
	public static Font showDialog(String title, Font font) {
		...
		/*
		 * Point p1 = parent.getLocation(); Dimension d1 = parent.getSize();
		 * Dimension d2 = dialog.getSize();
		 * 
		 * int x = p1.x + ((d1.width - d2.width) / 2); int y = p1.y +
	 ...
	 */
	private void jbInit() {
		GridBagConstraints gridBagConstraints = new GridBagConstraints(0, 1, 3,
		...
		jPanel3.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), " "
						+ PluginServices.getText(this, "Font") + " "));
		...
		jPanel4.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), " "
						+ PluginServices.getText(this, "Style") + " "));
		...
		jPanel1.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), " "
						+ PluginServices.getText(this, "Sample") + " "));
		...
		jButtons.add(jOk, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
		...
		jButtons.add(jCancel, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5,
						5, 5, 5), 0, 0));
		...
		add(jButtons, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0,
	...
	private void jStyleActionPerformed(java.awt.event.ActionEvent evt) {
		...
		while (st.hasMoreTokens()) {
			...
			if (str.equalsIgnoreCase(PluginServices.getText(this, "Plain"))) {
				style |= Font.PLAIN;
			} else if (str.equalsIgnoreCase(PluginServices
					.getText(this, "Bold"))) {
				style |= Font.BOLD;
			} else if (str.equalsIgnoreCase(PluginServices.getText(this,
					"Italic"))) {
				style |= Font.ITALIC;
			}
		}
