 ...
 * consequence of a 2D polyline drawn by the mouse.
 * </p>
 * 
...
public interface PolylineListener extends ToolListener {
	/**
	 * <p>
	 * Called when user moves the mouse after selecting a vertex of the
	 * polyline.
	 * </p>
	 * <p>
	 * Each kind of polyline listener calculates different information with the
	 * data of the <code>MeasureEvent</code>, according its nature.
	 * </p>
	 * 
	 * @param event
	 *            information about the mouse event, and geometry data of the
	 *            polyline
	 * 
	...
	/**
	 * <p>
	 * Called when user executes a mouse click and selects a vertex of the
	 * polyline.
	 * </p>
	 * 
	 * @param event
