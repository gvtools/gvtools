...
public class DefaultLegendFactory implements LegendFactory {
	...
	public IntervalLegend createIntervalLegend(Color start, Color end,
			...
			Layer layer, String field, int nIntervals) throws IOException {
		return new DefaultIntervalLegend(start, end, nIntervals, defaultSymbol,
				useDefault, type, layer, field, this, styleFactory,
				filterFactory);
	}

	@Override
	public IntervalLegend createIntervalLegend(
			Map<Interval, Symbolizer> symbols, Type type,
			Symbolizer defaultSymbol, boolean useDefault, String field)
			throws IOException {
		return new DefaultIntervalLegend(symbols, defaultSymbol, useDefault,
				type, field, this, styleFactory, filterFactory);
	}
	...
	public Symbolizer createDefaultSymbol(Class<? extends Geometry> type,
		...
		int width = getDefaultWidth(type);
