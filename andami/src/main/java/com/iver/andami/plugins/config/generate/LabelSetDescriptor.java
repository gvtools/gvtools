 ...
 * Schema.
 * $Id: LabelSetDescriptor.java 15983 2007-11-07 11:11:19Z vcaballero $
 */
 ...
 *          2007) $
 */
public class LabelSetDescriptor extends
	...
	public LabelSetDescriptor() {
		...
		// -- _labelList
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
				com.iver.andami.plugins.config.generate.Label.class,
				"_labelList", "label", org.exolab.castor.xml.NodeType.Element);
		handler = (new org.exolab.castor.xml.XMLFieldHandler() {
			public java.lang.Object getValue(java.lang.Object object)
					throws IllegalStateException {
				LabelSet target = (LabelSet) object;
